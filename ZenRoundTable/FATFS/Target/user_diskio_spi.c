...
#include "stm32f1xx_hal.h" /* Provide the low-level HAL functions */	// Changed from 32F3 to 32F1 22.03.24 SM
...
#define FCLK_FAST() { MODIFY_REG(SD_SPI_HANDLE.Instance->CR1, SPI_BAUDRATEPRESCALER_256, SPI_BAUDRATEPRESCALER_64); }	/* Set SCLK = fast, approx 4.5 MBits/s */ //TODO 15.07 SPI_BAUDRATEPRESCALER_8->SPI_BAUDRATEPRESCALER_64
